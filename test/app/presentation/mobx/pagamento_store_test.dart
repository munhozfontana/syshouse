...
void main() {
  ...
  mockPagamentoApiConnected(() {
    test('Find complete flow', () async {
      await storePagamento.changePagamento(pagamentoParam);
    ...
    test('Save complete flow', () async {
      ...
      await mockSave(storePagamento.param);
    ...
    test('Update complete flow', () async {
      ...
      await mockUpdate(storePagamento.param);
