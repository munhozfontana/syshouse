...
void main() {
  TipoPatrimonioApiImpl tipopatrimonioApi;
  ...
  void mockInternalServerErrorException(Function body) {
    group('throw InternalServerErrorException', () {
      setUp(() {
        when(tipopatrimonioApi.apiValidation.validate(any))
  ...
  test("find one by id", () async {
    ...
    var res = await tipopatrimonioApi.find(id);
  ...
  test("list all", () async {
    ...
    var res = await tipopatrimonioApi.listAll();
  ...
  test("list All by Page", () async {
    ...
    var res = await tipopatrimonioApi.listAllPage(0, 5);
  ...
  test('save (new)', () async {
    ...
    var res = await tipopatrimonioApi.save(body.toJson());

    expect(res, TipoPatrimonioModel());
  });

  test('save (update)', () async {
    mockUpdate(body.toJson());

    TipoPatrimonioModel res = await tipopatrimonioApi.save(body.toJson());

    expect(res, body);
  });

  test('remove', () async {
    await tipopatrimonioApi.delete(id);
  });
  ...
  group('check throws', () {
    mockClientServerErrorException(() {
      ...
      test("list All by Page", () async {
        ...
        expect(
          tipopatrimonioApi.listAllPage(0, 5),
          throwsA(
            isA<ClientServerErrorException>(),
          ),
        );
      ...
      test('save (new)', () async {
        ...
        expect(
            tipopatrimonioApi.save(body.toJson()),
            throwsA(
              isA<ClientServerErrorException>(),
            ));
      });
