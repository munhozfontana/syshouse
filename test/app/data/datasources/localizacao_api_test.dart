...
void main() {
  ...
  test("list all", () async {
    ...
    var res = await localizacaoApi.listAll();
  ...
  test("list All by Page", () async {
    ...
    var res = await localizacaoApi.listAllPage(0, 5);
  ...
  test('save (new)', () async {
    ...
    var res = await localizacaoApi.save(body.toJson());
  ...
  test('save (update)', () async {
    ...
    LocalizacaoModel res = await localizacaoApi.save(body.toJson());
  ...
  group('check throws', () {
    mockClientServerErrorException(() {
      ...
      test("list All by Page", () async {
        ...
        expect(
          localizacaoApi.listAllPage(0, 5),
          throwsA(
            isA<ClientServerErrorException>(),
          ),
        );
      ...
      test('save (new)', () async {
        ...
        expect(
            localizacaoApi.save(body.toJson()),
            throwsA(
              isA<ClientServerErrorException>(),
            ));
      });
