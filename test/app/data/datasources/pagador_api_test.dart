...
void main() {
  ...
  test("list all", () async {
    ...
    var res = await pagadorApi.listAll();
  ...
  test("list All by Page", () async {
    ...
    var res = await pagadorApi.listAllPage(0, 5);
  ...
  test('save (new)', () async {
    ...
    var res = await pagadorApi.save(body.toJson());
  ...
  test('save (update)', () async {
    ...
    PagadorModel res = await pagadorApi.save(body.toJson());
