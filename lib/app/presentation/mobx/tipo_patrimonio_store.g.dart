...
mixin _$StoreTipoPatrimonio on _StoreTipoPatrimonioBase, Store {
  ...
  @override
  TipoPatrimonio get resFind {
    _$resFindAtom.reportRead();
    return super.resFind;
  }

  @override
  set resFind(TipoPatrimonio value) {
  ...
  @override
  List<TipoPatrimonio> get reslist {
    _$reslistAtom.reportRead();
    return super.reslist;
  }

  @override
  set reslist(List<TipoPatrimonio> value) {
  ...
  @override
  List<TipoPatrimonio> get reslistPage {
    _$reslistPageAtom.reportRead();
    return super.reslistPage;
  }

  @override
  set reslistPage(List<TipoPatrimonio> value) {
  ...
  @override
  TipoPatrimonio get resSave {
    _$resSaveAtom.reportRead();
    return super.resSave;
  }

  @override
  set resSave(TipoPatrimonio value) {
